...
class TransactionViaAccount(ProcessTransaction):
    ...
    def execute(self):
        ...
        try:
            ...
            try:
                ...
                print("\nPayment successful using account")
                return True
    ...
    def authenticate(self):
        # Implement the logic
        print(f"Authenticated user {self.src.getName()} and {self.dest.getName()} for transaction via account")